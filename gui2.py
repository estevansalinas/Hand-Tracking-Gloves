...
tempValue = "A1024B1024C1024D1024E1024F0.000G0.000H0.000I0.000J0.000K0.000L0.000M0.000O0.000"
currentValue = "A1B1C1D1E1F1.000G3.000H2.000I5.000J6.000K2.000L3.000M4.000O5.000"
...
ayLabel = Label(root)
azLabel = Label(root)
rollLabel = Label(root)
pitchLabel = Label(root)
yawLabel = Label(root)
...
def stringtoValues():
    ...
    if(update):
        ...
        for x in arrayCheck:
            percents[x] = (numbers[x]/voltMax[x])*100 #pinky
            if percents[x] > 100:
                voltMax[x] = numbers[x]
        ...
        rollLabel.config(text="Roll:"+str(numbers[11]),font=("Arial", 15))
        pitchLabel.config(text="Pitch:"+str(numbers[12]),font=("Arial", 15))
        yawLabel.config(text="Yaw:"+str(numbers[13]),font=("Arial", 15))
        ...
        rollLabel.grid(row=8, column=3,pady=10)
        pitchLabel.grid(row=9, column=3,pady=10)
        yawLabel.grid(row=9, column=4,pady=10)
